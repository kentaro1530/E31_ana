...
void draw_sub(){
  ...
  gra_I0_calc_A=set(gra_I0_calc_A);
  gra_interfer_calc_A=set(gra_interfer_calc_A);
  gra_I1_calc_A=set(gra_I1_calc_A);

  gra_I0_calc_B=set(gra_I0_calc_B);
  gra_interfer_calc_B=set(gra_interfer_calc_B);
  gra_I1_calc_B=set(gra_I1_calc_B);
