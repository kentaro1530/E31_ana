...
void draw_all_A(){
  ...
  TGraph *gra_pimSp_calc=(TGraph*)f->Get("pimSp_modelA_conv");
  TGraph *gra_pipSm_calc=(TGraph*)f->Get("pipSm_modelA_conv");
  ...
  c1-> Print("~/ag_Run78/pic/Dron/interfer_A.eps");

  gra_pimS0-> Draw("AP");
  gra_I1_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/Dron/I1_A.eps");

  gra_I0-> Draw("AP");
  gra_I0_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/Dron/I0_A.eps");

  gra_pimSp-> Draw("AP");
  gra_pimSp_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/Dron/DCC_pimSp_A.eps");

  gra_pipSm-> Draw("AP");
  gra_pipSm_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/Dron/DCC_pipSm_A.eps");
}
