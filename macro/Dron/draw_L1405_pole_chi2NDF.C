...
void draw_L1405_pole_chi2NDF(){
  ...
  TGraph *gra_chi2NDF_Kmp=setOpts(make_chi2NDF_graph(sigma_list, pole_Kmp_chi2, pole_Kmp_NDF), 6);
  TGraph *gra_chi2NDF_KN=setOpts(make_chi2NDF_graph(sigma_list, pole_KN_chi2, pole_KN_NDF), kRed);
  TGraph *gra_chi2NDF_KzeroN=setOpts(make_chi2NDF_graph(sigma_list, pole_KzeroN_chi2, pole_KzeroN_NDF), kBlue);
