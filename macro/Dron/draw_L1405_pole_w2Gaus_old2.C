...
void draw_L1405_pole_w2Gaus(){
  ...
  double sigma_list[]={ 1.0, 1.5, 2.0, 2.5, 3.0, 9999 };
  ...
  // TGraph *gra_chi2NDF_Kmp=setOpts(make_chi2NDF_graph(pole_Kmp_chi2, sigma_list, pole_Kmp_NDF), 6);
  // TGraph *gra_chi2NDF_KN=setOpts(make_chi2NDF_graph(pole_KN_chi2, sigma_list, pole_KN_NDF), kRed);
  // TGraph *gra_chi2NDF_KzeroN=setOpts(make_chi2NDF_graph(pole_KzeroN_chi2, sigma_list, pole_KzeroN_NDF), kBlue);
