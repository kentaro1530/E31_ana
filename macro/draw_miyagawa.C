...
void draw_miyagawa(){
  ...
  gra_pimSp_data-> GetYaxis()-> SetRangeUser(0., 40.);
  ...
  c1-> Print("pic/discussion/miyagawa_pimSp.eps");
  c1-> Print("pic/discussion/miyagawa_pimSp.png");
  ...
  gra_pipSm_data-> GetYaxis()-> SetRangeUser(0., 40.);
  ...
  leg-> Draw();
  c1-> Print("pic/discussion/miyagawa_pipSm.eps");
  c1-> Print("pic/discussion/miyagawa_pipSm.png");
  ...
  gra_pimS0_data-> GetYaxis()-> SetRangeUser(0., 40.);
  ...
  leg-> Draw();
  c1-> Print("pic/discussion/miyagawa_pimS0.eps");
  c1-> Print("pic/discussion/miyagawa_pimS0.png");
