...
void draw_kamano(){
  ...
  leg-> Draw();
  c1-> Print("~/ag_Run78/pic/discussion/DCC_pimSp.eps");
  ...
  line.DrawLine(kpThre, 0., kpThre, 35);
  leg-> Draw();
  c1-> Print("~/ag_Run78/pic/discussion/DCC_pimS0.eps");
}
