...
void draw_all(){
  ...
  c1-> Print("~/ag_Run78/pic/JPS_2022/interfer_B.eps");

  gra_pimS0-> Draw("AP");
  gra_I1_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/JPS_2022/I1_B.eps");

  gra_I0-> Draw("AP");
  gra_I0_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/JPS_2022/I0_B.eps");

  gra_pimSp-> Draw("AP");
  gra_pimSp_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/JPS_2022/DCC_pimSp_B.eps");

  gra_pipSm-> Draw("AP");
  gra_pipSm_calc-> Draw("PL");
  line.DrawLine(kpThre, 0.0, kpThre, 30);
  c1-> Print("~/ag_Run78/pic/JPS_2022/DCC_pipSm_B.eps");
}
