...
void draw(){
  ...
  gra_pimSp_A_conv-> SetLineWidth(4);
  gra_pimSp_B_conv-> SetLineWidth(4);
  gra_pipSm_A_conv-> SetLineWidth(4);
  gra_pipSm_B_conv-> SetLineWidth(4);
  gra_pimS0_A_conv-> SetLineWidth(4);
  gra_pimS0_B_conv-> SetLineWidth(4);
  ...
  gra_pipSm_A-> GetYaxis()-> SetRangeUser(0., 30.);
  gra_pipSm_A-> Draw("AL");
  ...
  gra_pipSm_B-> GetYaxis()-> SetRangeUser(0., 30.);
  gra_pipSm_B-> Draw("AL");
